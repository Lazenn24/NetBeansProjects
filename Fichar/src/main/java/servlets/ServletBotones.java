    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (session == null) {
                ...
                if (boton.equals("Fichar entrada") && boton != null) {
                ...
                } else if (boton.equals("Fichar salida") && boton != null) {
                    // Para comprobar el tipo del ultimo registro
                    ...
                    if (getServletContext().getAttribute("horario") != null) {
                        ...
                        if ((ArrayList<UserSchedule>) horarios.get(user) != null) {
                            ...
                            if (!horarioUsuario.isEmpty() && (EntradaSalida) horarioUsuario.get(horarioUsuario.size() - 1).getTipo() == EntradaSalida.SALIDA) {
                    ...
                    request.getSession().setAttribute("registro", registro);
                    tabla.forward(request, response);
                } else if (boton.equals("Cerrar sesion") && boton != null) {
