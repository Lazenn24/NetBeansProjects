 ...
 * @author admin
 */
@WebFilter(filterName = "Compression", urlPatterns = {"*.jsp"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
public class Compression implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("Compression:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("Compression:DoAfterProcessing");
        }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("Compression(");
